...
This is handeld within makeStream or within the translation rules, hence a rel(relsubquery(... term is never passed to the term_to_atom predicates.
...
:- op(935,  fx,  nonempty).
%:- op(930, xfx,  as).
:- op(930, xfy,  as). % NVK MODIFIED NR, compare testquery 821
:- op(930, xf ,  asc).
:- op(930, xf ,  desc).
