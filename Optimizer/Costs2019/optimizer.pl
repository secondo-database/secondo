...
% KS ADDED Section is replaced in costs2014.pl
...
cost(res(N), _, _, Size, 0) :-
  resultSize(N, Size),nl, write("RESN SIZE: " ),write(Size),nl,nl.
...
createCostEdge :- % use standard cost functions
  ...
  Cost is Cost1 / 1000,	
write('OLD Cost function called for term '), 
write(Term), nl,  % old estimation in microseconds
