...
% moving the following line into predicate 'intOrdersTOSImplementation' results in errors.
% The reason is still unknown. Also, using 'retractall/1' instead of 'retract/1' causes
% problems (also in the line above):
