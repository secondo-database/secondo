...
%used for removing the filter conditions that were added
%to optimize the spatiotemporal pattern predicate.
%These were generated by the optimizer by rewriting the
%pattern operator
%Other user filter conditions in the same form
%will not be removed
