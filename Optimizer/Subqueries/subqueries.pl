...
Subquery aus Pr�dikat extrahieren,
korrelierte Pr�dikate aus Subquery entfernen und mit queryToPlan Plan ermitteln
korrelierte Pr�dikate mit filter einf�gen, Reihenfolge mit Hilfe der selectivity ermitteln?
