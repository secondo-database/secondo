...
Operator extrelmergejoin(
		 ...
		 mergeouterjoin_vm<true, false>,        // value mapping
         Operator::SimpleSelect,  // trivial selection function
...
Operator extrelsortmergejoin(
		 ...
		 mergeouterjoin_vm<false, false>,        // value mapping
         Operator::SimpleSelect,     // trivial selection function
...
This operator sorts two input streams and computes their equiouterjoin.

2.16.1 Specification of operator ~sortmergeouterjoin~
...
Operator extrelsmouterjoin(
         ...
         mergeouterjoin_vm<false, true>,        // value mapping
         Operator::SimpleSelect,     // trivial selection function
         JoinTypeMap<false, 1>       // type mapping
);
