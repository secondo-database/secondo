...
where [s:ssuppkey = ps:pssuppkey, s:snationkey = n:nnationkey, n:nregionkey = r:rregionkey, r:rname = "EUROPE"]
\end{lstlisting}
...
where [ppartkey = pspartkey_ps] groupby pspartkey_ps
\end{lstlisting}

\begin{lstlisting}[caption=Entschachtelte Variante von Abfrage Q2]
select [sacctbal, sname, nname, ppartkey, pmfgr, saddress, sphone, scomment]
from [part, supplier, partsupp, nation, region, trelxx3 as alias1]
where 
	[ppartkey = pspartkey, 
	ssuppkey = pssuppkey, 
	psize = 15, 
	ptype contains[66, 82, 65, 83, 83], 
	snationkey = nnationkey, 
	nregionkey = rregionkey, 
	rname = [69, 85, 82, 79, 80, 69], 
	ppartkey = alias1:pspartkey_ps, 
	pssupplycost = alias1:var1]
orderby [sacctbal desc, nname, sname, ppartkey]
first 100
\end{lstlisting}
...
\pgfplotsset{every x tick label/.style={below, yshift=-0.25em, rotate=30, xshift=-2em}}
...
\addplot coordinates {(0,	1.129	)(1,	0.001	)(2,	0.001	)(3,	0.001	)};
\addplot coordinates {(0,	0.004	)(1,	0.004	)(2,	0.221	)(3,	0.155	)};
\addplot coordinates {(0,	1.179	)(1,	0.581	)(2,	0.298	)(3,	0.31	)};
\addplot coordinates {(0,	1.179	)(1,	1.219	)(2,	10.609	)(3,	10.61	)};
...
axis y line=right,
axis x line=none,
%y label style={yshift=},
ylabel=percent]
\end{axis}
\end{tikzpicture}

A = entschachtelte Ausführung, B ist iterativ geschachtelte Ausführung. Wie man der Graphik entnehmen kann, 
