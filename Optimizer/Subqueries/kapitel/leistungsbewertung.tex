...
Einschränkung der inneren Relation durch alle \emph{einfachen} Prädikaten.
...
Equi-Join der ersten und zweiten temporären Relationen und Berechnung der Aggregation. Da sich Optimierer und \textsc{Secondo} in der Syntax für umbenannte Tupel unterscheiden muss hier auf die ausführbare Syntax der Spalten zurück gegriffen werden. 
...
wurde durch die zwei Prädikate \sql{ppartkey = txxrel4:pspartkey\_ps} und \sql{pssupplycost = txxrel4:var1} ersetzt. Zusätzlich wurde die neue Relation txxrel3 in die FROM-Klausel aufgenommen. Die Prädikate der entschachtelten Variante sind nur noch einfache und Join-Prädikate.
...
Da es sich bei der inneren Abfrage in dem ersten geschachtelten Prädikat um eine nicht-korrelierte Abfrage handelt, wird sie in der entschachtelten Variante durch den durch ihre Ausführung erhaltenene Wert ersetzt.
...
\subsection{Fazit}
Bis auf wenige Ausnahmen (Q17 und Q21) ist die entschachtelte Ausführung der iterativen Ausführung in den betrachteten überlegen.
\subsection{Ausblick}
