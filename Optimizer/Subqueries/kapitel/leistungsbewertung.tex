...
wurde durch die zwei Prädikate \sql{pssupplycost = txxrel4:var1} und \sql{ppartkey = txxrel4:pspartkey\_ps} ersetzt. Das erste der beiden Prädikate ergibt sich direkt aus dem geschachtelten Prädikat, während das zweite Prädikat die Korrelation abbildet. Zusätzlich wurde die neue Relation txxrel3 in die FROM-Klausel aufgenommen. Die Prädikate der entschachtelten Variante sind nur noch einfache und Join-Prädikate.
