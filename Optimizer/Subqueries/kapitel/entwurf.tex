...
In diesem Kapitel werden die Kriterien für die Auswahl der implementierten Algorithmen dargestellt. Anschließend werden die theoretischen Grundlagen der einzelnen Algorithmen ausführlich beleuchtet. 
...
\begin{enumerate}
  \item Sind beide Relationen erschöpft, so ist der Algorithmus beendet.
	...
	\subitem Zeigt der Zeiger für das aktuelle auf 0, so wird der Zeiger auf das nächste Tupel der ersten Relation gesetzt und der Zeiger in der ersten Relation erhöht. Ist die erste Relation erschöpft, wird das Flag auf die zweite Relation gesetzt.
