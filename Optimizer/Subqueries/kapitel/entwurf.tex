...
\lstinline[mathescape=true]{$C_n$ $\theta$ (select AGGR($C_n$) from $R_i$ where P)}. 
...
\lstinline[mathescape=true]{$C_n$ $\theta$ (select AGGR($C_n$) from $R_i$ where P)}. Wobei hier gilt
\begin{math}
AGGR = 
\begin{cases}
