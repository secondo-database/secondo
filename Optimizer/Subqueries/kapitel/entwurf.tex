...
\chapter{Entwurf}
Der von Kim bzw. Ganski/Wong vorgestellte Algorithmus zur Optimierung geschachtelter Abfragen hat für die Implementierung in \textsc{Secondo} den Vorteil, dass er sich mit der Einführung eines weiteren Operators in die bestehende \textsc{Secondo}-Implementierung integrieren lässt. 
\begin{itemize}
...
Idee des Algorithmus ist es, die Abfrageblöcke zu verschmelzen. Dafür wird die Konjunktion der WHERE-Klauseln gebildet und um ein Join-Prädikat ergänzt, das aus dem ursprünglich geschachtelten Prädikat abgleitet ist.
