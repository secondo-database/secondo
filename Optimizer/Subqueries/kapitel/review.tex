...
In \cite{319745} wurde erstmals die Möglichkeit vorgestellt, eine geschachtelte Abfrage durch Transformation in eine semantisch äquivalente, nicht geschachtelte Abfrage zu optimieren. Die dort vorgestellten Algorithmen benötigen nur die erweiterten Standard-Operationen der Relationen Algebra. 
\begin{itemize}
	\item G-Aggregation 
	\item G-Join
	\item G-Restriction
