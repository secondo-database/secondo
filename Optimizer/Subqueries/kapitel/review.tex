...
\begin{itemize}
	...
	\subitem \textbf{SELECT-Klausel} das Ergebnis der Auswertung der geschachtelten Abfrage wird in die Ergebnisrelation aufgenommen
	\subitem \textbf{FROM-Klausel} komplexe Abfragen lassen sich oft verständlicher formulieren, 
