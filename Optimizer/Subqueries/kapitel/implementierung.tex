...
Die Beschreibung Umsetzung der in Kapitel \ref{cpt:Entwurf} vorgestellten Überlegungen in diesem Kapitel folgt der Reihenfolge der im Optimierer durchlaufenen Schritte bei der Optimierung einer Abfrage. Nach einem kurzen Exkurs zur Umsetzung des Full-Outer-Join-Operators im \textsc{Secondo}-Kernels werden die einzelnen Optimierungsschritte bei einer geschachtelten Abfrage beschrieben und anhand einiger Beispiele erläutert. 
