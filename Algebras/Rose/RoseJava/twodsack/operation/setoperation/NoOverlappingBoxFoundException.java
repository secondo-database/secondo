...
/**
 * A NoOverlappingboxFoundException is thrown when there is no pair of overlapping bounding boxes found for two sets
 * of elements. This exception is generally thrown by the overlappingPairs() method. When caught, a new EarlyExit
