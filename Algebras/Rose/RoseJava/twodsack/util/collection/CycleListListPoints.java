 ...
 * necessary.<p>
 * A CycleListListPoints itself is a LinkedList which has CycleList(s) as elements. Each of those CycleList(s) represents one face
 ...
 * cycles (if any) are hole cycles. A CycleList has LinkedList(s) as elements that have Point objects as elements, here.
 */
