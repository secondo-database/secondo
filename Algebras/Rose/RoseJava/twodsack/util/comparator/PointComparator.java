...
/**
 * A PointComparator is used wherever objects of type {@link Point} shall be inserted in a sorted set working with objects of type {@link MultiSetEntry}.
 * Then, in the constructor an instance of this
 * constructor is needed. It sorts the Point objects by calling the <tt>Point.compare()</tt> method.
 */
public class PointComparator implements Comparator,Serializable {
     ...
     * Calls the <tt>compare()</tt> method for two Point values stored in MultiSetEntry types.
     ...
     * @throws WrongTypeException if <tt>ino1.o</tt> or <tt>ino2.o</tt> is not of type Point
     */
