...
// #endif
  ...
  // added by Dirk Ansorge
  // construct spline geometry from point array
  Ng_Geometry_2D * Ng_ConstructGeometry_2D (double * pointarray, int size, int * lengtharray, int lsize, unsigned char * directionarray, int dsize);
