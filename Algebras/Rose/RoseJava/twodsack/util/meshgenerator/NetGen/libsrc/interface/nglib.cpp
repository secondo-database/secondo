...
Ng_Geometry_2D * Ng_ConstructGeometry_2D (double * pointarray, int size,
					  int * lengtharray, int lsize,
					  unsigned char * directionarray, int dsize)
{
  //cout << "Ng_ConstructGeometry_2D, size: " << size << endl;
  SplineGeometry2d * geom = new SplineGeometry2d();
  geom -> ConstructFromArray(pointarray,size,lengtharray,lsize,directionarray,dsize);
  return (Ng_Geometry_2D *)geom;
}

//added by Dirk Ansorge
void Ng_CleanUp (Ng_Geometry_2D * geom) {
			      ...
			      Ng_Meshing_Parameters * mp)
{
  ...
  */
  ...
  //print out mparam values:
  /*
  cout << "\nmparam values:" << endl;
  cout << "optimize2d: " << mparam.optimize2d << endl;
  cout << "optsteps2d: " << mparam.optsteps2d << endl;
  cout << "opterrpow: " << mparam.opterrpow << endl;
  cout << "blockfill: " << mparam.blockfill << endl;
  cout << "parthread: " << mparam.parthread << endl;
  cout << "maxh: " << mparam.maxh << endl;
  */
  Mesh * m;
