...
\begin{figure}
	\centering
	\subfloat[nach Grröße der Relation\label{img:sortHeadExp}]{{\includegraphics[width=0.45\textwidth]{Bilder/sort_head.png}}}
	\qquad
	\subfloat[nach Grröße der Relation mit mehreren Suchattributen\label{img:sortHeadMfExp}]{{\includegraphics[width=0.45\textwidth]{Bilder/sort_head_mf.png}}}
	\qquad
	\subfloat[nach verfügbarem Speicher\label{img:sortMemExp}]{{\includegraphics[width=0.45\textwidth]{Bilder/sort_mem.png}}}
...
\begin{figure}
	\centering
	\subfloat[Selfjoin\label{img:sjHeadExpRr}]{{\includegraphics[width=0.70\textwidth]{Bilder/sj_head_rr.png}}}
	\qquad	
	\subfloat[$waterways \bowtie roads$\label{img:sjHeadExpWr}]{{\includegraphics[width=0.70\textwidth]{Bilder/sj_head_wr.png}}}	
