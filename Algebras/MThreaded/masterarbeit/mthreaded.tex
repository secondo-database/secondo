...
Da ich hier Operatoren nur für eine shared-all Architektur entwickle, ist es wichtig, deren Implikationen insbesondere zu betrachten. Ein gemeinsam geteilter Permanentspeicher bedeutet, dass I/O-Operationen zum Flaschenhals werden können, da hier keine Parallelisierung möglich ist. Algorithmen müssen also so gewählt werden, dass sie so wenig I/O-intensiv sind wie möglich. Geteilter Speicher dagegen ermöglicht eine vergleichweise kostengünstige Kommunikation zwischen den Prozessen und die Nutzung globaler Strukturen, die von allen Prozessen geteilt werden.
...
Openstreetmapdaten Berlin

\subsubsection{Funktionstest MThreadedsort}

--valgrind
query buildings feed  mThreadedMergeSort[Name]  project[Name] count

==11278== HEAP SUMMARY:
==11278==     in use at exit: 1,652,231 bytes in 17,840 blocks
==11278==   total heap usage: 1,726,857 allocs, 1,709,017 frees, 269,032,078 bytes allocated
==11278== 
==11278== LEAK SUMMARY:
...
==11278==    still reachable: 1,652,231 bytes in 17,840 blocks


definitely lost: 16 bytes in 1 blocks
==11428== 16 bytes in 1 blocks are definitely lost in loss record 1 of 129
==11428==    at 0x4C2E68F: operator new(unsigned long) (in /usr/lib64/valgrind/vgpreload_memcheck-amd64-linux.so)
