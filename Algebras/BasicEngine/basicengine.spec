...
operator be_mquery alias BE_MQUERY pattern op (_, _, _)
operator be_mcommand alias BE_MCOMMAND pattern op (_, _)
operator be_union alias BE_UNION pattern op (_, _)
operator be_union2 alias BE_UNION2 pattern op (_, _)
