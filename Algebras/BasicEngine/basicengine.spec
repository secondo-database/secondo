...
operator be_mquery alias BE_MQUERY pattern op (_,_,_,_)
operator be_mcommand alias BE_MCOMMAND pattern op (_,_,_)
...
operator be_grid_create alias BE_GRID_CREATE pattern op (_,_,_,_,_,_)
...
operator be_part_grid alias BE_PART_GRID pattern op (_,_,_,_,_)
...
operator be_repart_grid alias BE_REPART_GRID pattern op (_,_,_,_,_)
