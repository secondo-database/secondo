...
[1] Database generator for ipoint relations
...
int main()
{
  ofstream output("IPointDB");
  output << "(DATABASE IPOINT (TYPES)(OBJECTS" << endl;

/******************************************************************************

Relation with 10000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint10000Rel()(rel(tuple((ip ipoint))))(";
...
Relation with 50000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint50000Rel()(rel(tuple((ip ipoint))))(";
  for (int i = 0; i < maxMoID; i++) { posXArray[i] = (int)rand()%1000; }
  for (int i = 0; i < maxMoID; i++) { posYArray[i] = (int)rand()%1000; }
...
Relation with 100000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint100000Rel()(rel(tuple((ip ipoint))))(";
  for (int i = 0; i < maxMoID; i++) { posXArray[i] = (int)rand()%1000; }
  for (int i = 0; i < maxMoID; i++) { posYArray[i] = (int)rand()%1000; }
...
Relation with 200000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint200000Rel()(rel(tuple((ip ipoint))))(";
  for (int i = 0; i < maxMoID; i++) { posXArray[i] = (int)rand()%1000; }
  for (int i = 0; i < maxMoID; i++) { posYArray[i] = (int)rand()%1000; }
...
Relation with 300000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint300000Rel()(rel(tuple((ip ipoint))))(";
  for (int i = 0; i < maxMoID; i++) { posXArray[i] = (int)rand()%1000; }
  for (int i = 0; i < maxMoID; i++) { posYArray[i] = (int)rand()%1000; }
...
Relation with 400000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint400000Rel()(rel(tuple((ip ipoint))))(";
  for (int i = 0; i < maxMoID; i++) { posXArray[i] = (int)rand()%1000; }
  for (int i = 0; i < maxMoID; i++) { posYArray[i] = (int)rand()%1000; }
...
Relation with 500000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint500000Rel()(rel(tuple((ip ipoint))))(";
  for (int i = 0; i < maxMoID; i++) { posXArray[i] = (int)rand()%1000; }
  for (int i = 0; i < maxMoID; i++) { posYArray[i] = (int)rand()%1000; }
...
Relation with 1000000 ipoints 

******************************************************************************/

  year = 2010; month = 1; day = 1; hour = 0; minute = 0; second = 0;
  output << "(OBJECT ipoint1000000Rel()(rel(tuple((ip ipoint))))(";
  for (int i = 0; i < maxMoID; i++) { posXArray[i] = (int)rand()%1000; }
  for (int i = 0; i < maxMoID; i++) { posYArray[i] = (int)rand()%1000; }
