...
operator mclosestCenterN alias MCLOSESTCENTERN pattern _ _ op [_]
...
operator mnearestNeighborN7 alias MNEARESTNEIGHBORN7 pattern _ _ op [_,_]
operator mnearestNeighborN8 alias MNEARESTNEIGHBORN8 pattern _ _ op [_,_]
