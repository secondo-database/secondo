...
//[$][\$]
 ...
 Version 1.1 - Added checkCellOriginal to find out which attributes still 
	       exists because they get deleted from some Operators. - D.Selenyi- 19.08.2020
...
*/
    class DRelHelpers {
        public:
            ...
            static bool checkCellOriginal(
                int *checkOriginal, int *checkCell, ListExpr *attrList, 
                ListExpr *relType);
    };
