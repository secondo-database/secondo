...
*/
    ...
    ListExpr DRelT<T>::toListExpr( ListExpr typeInfo ) const {
        ...
        #ifdef DRELDEBUG
        cout << endl << "DRelT::toListExpr" << endl;
        cout << "typeInfo" << endl;
        cout << nl->ToString( typeInfo ) << endl;
        cout << "nl->Third( typeInfo ): ";
        cout << nl->ToString(nl->Third( typeInfo )) << endl;
        #endif
        ...
        #ifdef DRELDEBUG
        cout << "drelList" << endl;
        cout << "distType->toListExpr( nl->Third( typeInfo ) ): ";
        cout << nl->ToString(distType->toListExpr(
                             nl->Third( typeInfo ) )) << endl;
