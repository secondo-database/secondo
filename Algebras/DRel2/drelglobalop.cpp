...
//[$][\$]
 ...
 Version 1.1 - Small improvements and checkcell/orginal added - D. Selenyi - 19.08.2020
        ...
        if( dType == replicated || ( dType == range && attr == pos ) ) {
            ...
            if( dType == spatial2d || dType == spatial3d ) {
                ...
                funText2 = " \"\" (fun (elem1_2 FFR) (elem2_2 FFR) "
                    ...
                    "(hashvalue (attr elem2_5 "+ attrName + ") 9999)) "
         ...
         || ( dType == range && attr == 0 ) ) {
            ...
            if( dType == spatial2d || dType == spatial3d ) {
                ...
                funText2 = " \"\" (fun (elem1_1 FFR) (elem2_2 FFR) "
                    ...
                    "(fun (streamelem_3 STREAMELEM) "
                    "(= (attr streamelem_3 Original) TRUE))) "
                    ") (fun (elem1_4 FFR) (elem2_5 FFR) "
                    "(hashvalue (attr elem2_5 "+ nl->ToString(attrName) + 
                    ") 9999)) 0) \"\" (fun (elem_6 AREDUCEARG1) (rdup "
                    "(feed elem_6))) " + getDRelPortString() + ")";



                 if (checkCell == 1 && checkOriginal == 1) {
