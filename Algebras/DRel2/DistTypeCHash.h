...
//[$][\$]
 ...
 @history
 Version 1.0 - Created - D. Selenyi - 01.07.2020
...
#ifndef _DistTypeCHash_h_
#define _DistTypeCHash_h_
...
This class represents the distribution type informations for the class
drel. The supported types are represented by the enum distributionType.
This type is used for chash distribution.

*/
    class DistTypeCHash : public DistTypeBasic {
    public:
/*
1.1 Methods

*/
        DistTypeCHash( distributionType _type, int _attr);

        DistTypeCHash( const DistTypeCHash& _distType );
        DistTypeCHash &operator=( const DistTypeCHash &_distType );
        virtual ~DistTypeCHash( );
