...
//[$][\$]
 ...
 Version 1.1 - Small improvements and Additional audit for spatial Data - D. Selenyi - 25.07.2020
...
This operators have the same value mapping which calls the dloop operator of 
...
Expect a drel, a string and an attribute.
...
*/
    ListExpr drelcreatebtreeTM( ListExpr args ) {
        ...
        if( nl->AtomType( arg3Type )!=SymbolType ) {
            return listutils::typeError(err + 
                ": thrid argument is not an attribute" );
        }
    ...
    ListExpr drelbulkloadrtreeTM( ListExpr args ) {
        ...
        if(nl->AtomType(nl->First(nl->Third(args)))!=SymbolType){
           return listutils::typeError(
                  "Third attribute is not a valid attr name");
        }
        ...
        if(!index){
          return listutils::typeError(
                 "Attribute >" + attrName + "< not part of the relation");
        }

        //Additional audit for spatial Data
        if( !DistTypeSpatial<CellGrid2D>::allowedAttrType2d( attrType ) 
            || !DistTypeSpatial<CellGrid<3>>::allowedAttrType2d( attrType )) 
        {
            return listutils::typeError(err + 
                ": attr type is not of kind spatial2d or spatial3d" );
        }
...
/*
1.3 ValueMapping Array dreldloop
...
/*
1.4 Selection function for dloop operators
...
1.5.1 Specification of drelcreatebtree
...
/*
1.5.2 Specification of drelbulkloadtree
...
/*
1.6 Operator instances

1.6.1 Operator instance of drelcreatebtree operator
...
/*
1.6.2 Operator instance of drelbulkloadrtree operator
