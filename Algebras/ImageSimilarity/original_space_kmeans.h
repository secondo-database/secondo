...
[1] Declarations for the OriginalSpaceKmeans  algorithm
...
class OriginalSpaceKmeans : public Kmeans {
    public:
        ...
        virtual double centerCenterInnerProduct(unsigned short c1ndx, 
        unsigned short c2ndx) const;
    ...
    protected:
        ...
        virtual void changeAssignment(int xIndex, int closestCluster, 
        int threadId);
