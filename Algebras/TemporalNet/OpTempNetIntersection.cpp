...
1.1 Implementation of Operator interssection

The operator returns a moving gpoint representing the intersection value of
the two given moving gpoint.
...
/*
Typemap function of the operator ~intersection~

*/
ListExpr OpTempNetIntersection::TypeMapping(ListExpr in_xArgs)
{
  ListExpr arg1, arg2;
...
/*
Value mapping function of operator ~intersection~

*/
int OpTempNetIntersection::ValueMapping(Word* args,
                                   Word& result,
                                   int message,
                                   Word& local,
...
/*
Specification of operator ~intersection~

*/
const string OpTempNetIntersection::Spec  =
