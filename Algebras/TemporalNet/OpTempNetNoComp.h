...
1.1 Declaration of Operator nocompoinents
...
#ifndef OPTEMPNETNOCOMP_H_
#define OPTEMPNETNOCOMP_H_

class OpTempNetNoComp
{
public:
/*

Type Mapping of operator ~nocomponents~
...
/*
4.4.3 Specification of operator ~nocomponents~

*/
static const string Spec;
};

#endif /*OPTEMPNETNOCOMP_H_*/
