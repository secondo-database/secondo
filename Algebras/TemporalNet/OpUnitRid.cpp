...
Returns the route ID of a given UGPoint as double value.
...
*/
ListExpr OpUnitRid::TypeMap(ListExpr in_xArgs)
{
...
*/
int OpUnitRid::ValueMapping( Word* args, Word& result, int message,
