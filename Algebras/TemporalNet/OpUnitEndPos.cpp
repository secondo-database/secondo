...
1.1 Implementation of Operator ~unitendpos~
...
*/
ListExpr OpUnitEndPos::TypeMap(ListExpr in_xArgs)
{
...
*/
int OpUnitEndPos::ValueMapping( Word* args, Word& result, int message,
...
*/
const string OpUnitEndPos::Spec  =
