...
1.1 Implementation of Operator ~unitrid~

Returns the start position of a given UGPoint
...
*/
ListExpr OpUnitStartPos::TypeMap(ListExpr in_xArgs)
{
...
*/
int OpUnitStartPos::ValueMapping( Word* args, Word& result, int message,
...
*/
const string OpUnitStartPos::Spec  =
