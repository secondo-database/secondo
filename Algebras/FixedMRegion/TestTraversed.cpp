...
bool createTestObject(double x=0.0, double y=0.0, 
  ...
  double max1a[]={1.0, 0.001}; //geändert für Test, korrekt: (1.0, 0.001)
...
void testtraversedCase2(){
  ...
  bool res = createTestObject(-1.0, 1.0, M_PI/2, 1.5);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase4(){
  ...
  bool res = createTestObject(0.0, 0.0, M_PI/2, 0.5);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase5(){
  ...
  bool res = createTestObject(0.0, -0.5, M_PI/2, 0.25);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase6(){
  ...
  bool res = createTestObject(0.5, -0.5, M_PI/2, 0.25);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase7(){
  ...
  bool res = createTestObject(0.0, -1.0, M_PI/2, 0.5);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase8(){
  ...
  bool res = createTestObject(1.0, 1.0, M_PI/2, 0.5);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase9(){
  ...
  bool res = createTestObject(1.0, 0.001, M_PI/2, 0.5);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase11(){
  ...
  bool res = createTestObject(1.0, -0.5, M_PI/2, 0.25);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase12(){
  ...
  bool res = createTestObject(-1.0, 0.0, M_PI/2, 1.0);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase13(){
  ...
  bool res = createTestObject(-0.5, -0.5, M_PI/2, 0.5);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase15(){
  ...
  bool res = createTestObject(0.5, 0.0, M_PI/2, 0.5);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedCase17(){
  ...
  bool res = createTestObject(0.5, -1.0, M_PI/2, 0.25);
  printf("%s\n", (res==true)?"OK":"FAILED");
}
...
void testtraversedNew2(){
  printf("Test testtraversedNew-Mini: \n");
  testtraversedCase9();
}
/*
