...
if (maxSize < 0) {
maxSize = (-maxSize) * Vertex::getSizeOnDisc() + getContainerSizeOnDisc();
}
...
os << "VertexContainerSmall: " << " maximum size on disc:" << getMaxSize();
...
throw std::runtime_error("VertexContainerSmall::binaryOp not implemented");
}
