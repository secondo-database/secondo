...
meaning =
"Returns the height value at location given by"
...
meaning =
"The operator produces a .stl file from the tin in "
...
meaning =
"Returns a new tin with all raster cells"
...
remark =
"To get tins from a raster with fewer triangles,"
...
meaning =
"Returns a tin from a stream of tuples and an integer defining"
...
"= raster contourlines[40] feed extendstream[V:components(vertices(.Contour)) ]"
" extend[P:center(.V),H:.Height] extend[Y:gety(.P)] sortby[Y desc] project[P,H]"
...
signature =
Tin::BasicType()
+ " -> stream( tuple([V1:point , H1:real ,"
" V2:point , H2:real, V3:point , H3:real, Part:integer] ))";
syntax = "_ tin2tuplestream";
meaning =
"Returns a stream of tuples from a tin. Each tuple "
...
tin::Tin::Open, tin::Tin::Save, tin::Tin::Close, tin::Tin::Clone,
0, //cast function
...
tin::TinAttribute::Open, tin::TinAttribute::Save, tin::TinAttribute::Close,
tin::TinAttribute::Clone, //object open, save, close, and clone
