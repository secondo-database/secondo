...
+ (PreciseDouble) ((site1->getY())) * (PreciseDouble) ((site1->getY())));
c02 = c2
* ((PreciseDouble) ((site2->getX())) * (PreciseDouble) ((site2->getX()))
- (PreciseDouble) ((ySweepLine)) * (PreciseDouble) ((ySweepLine))
+ (PreciseDouble) ((site2->getY())) * (PreciseDouble) ((site2->getY())));
a = c1 - c2;
...
c02 = c2
* (((site2->getX())) * ((site2->getX())) - ((ySweepLine)) * ((ySweepLine))
...
eq.createTriangle(newtriangle->getMaxYVertex(),
newtriangle->getMiddleYVertex(), vc.getVertexByYIndex(i), &newtriangle);
neighborMatch.push_back(newtriangle);
}
}
}
...
crneigh->getSite(), cmid->getSite(), clneigh->getSite(), rbp->getPrecalc(),
lbp->getPrecalc());
