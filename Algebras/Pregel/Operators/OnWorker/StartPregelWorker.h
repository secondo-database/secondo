...
#ifndef SECONDO_STARTPREGELWORKER_H
#define SECONDO_STARTPREGELWORKER_H

#include <Operator.h>
#include "../../../../include/QueryProcessor.h"

namespace pregel {
 class StartPregelWorker {
 public:
  ...
  static Operator startPregelWorker;

  static void startReceivingMessages(bool &allEmpty);

 private:
  static void compute(QueryProcessor *queryProcessor, std::string &function);
...
#endif //SECONDO_STARTPREGELWORKER_H
