...
dass es zwischen den erwünschten und den unerwünschten Matches einen Sprung in dem Graphen geben wird.  Diesen Sprung m"u"ste mit geeigneten statistischen Verfahren berechnet werden k"onnen. 
...
Aufgrund der oben benannten schlechten Laufzeit und unter dem Aspekt, dass kein vergleichbar geeignetes Verfahren gefunden wurde/zur Verfügung stand, wird in der vorliegenden Arbeit das wesentlich einfachere Schwellwertverfahren verwendet, dass wie folgt formuliert werden kann: \flqq Matche zwei Cycle, wenn der Abstand ihrer Referenzpunkte kleiner als der Schwellwert ist.\frqq
...
\item Die \index{Bewertung!Schwerpunkt}Schwerpunkt-Bewertung:
