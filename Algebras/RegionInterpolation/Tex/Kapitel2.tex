...
Das SECONDO-System setzt sich im Wesentlichen aus drei Komponenten zusammen, wie auch Abbildung~\vref{fig:AufbauSec} illustriert:
\begin{enumerate}
\item Der Kernel
...
\begin{figure}
	\centering
	\includegraphics[scale=0.65]{2.2.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9 \textwidth]{2.3.jpg.eps}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.7]{2_1.4a.eps}
