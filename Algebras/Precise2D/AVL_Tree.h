 ...
 */
 ...
 /*
  ...
  The precise value will be stored in ~result~. Additionally this function
  returns true if the segment is vertical and false, if not.
...
public:
 ...
 AVLSegment(mpq_class xLeft, mpq_class yLeft, mpq_class xRight,
