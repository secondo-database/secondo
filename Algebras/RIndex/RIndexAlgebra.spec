...
operator realJoinRindexVec    alias   REALJOINRINDEXVEC  pattern _ _ op [ _, _ ]
...
operator insertRStar    alias   INSERTRSTAR  pattern _ op [ _, _ ]

operator realJoinRStar    alias   REALJOINRSTAR  pattern _ _ op [ _, _ ,_,_]
