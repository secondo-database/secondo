...
operator crossings alias CROSSINGS pattern _ infixop _
...
operator touchpoints alias TOUCHPOINTS pattern  _ infixop _
operator commonborder alias COMMONBORDER pattern  _ infixop _
