...
const string OShortestPathDSpec =
  ...
  "representing the edges of a graph. Whereas each edge of the graph is "
  ...
  "attribute representing the costs of the edge. The tuples may contain further"
  "attributes giving additonal cost information or arbitrary informations for "
  "each edge. Besides this ordered relation the operator expects the start and "
  "end node identifiers and an selecting int value choosing the return value."
  ...
  "For the path computation Dijkstras Algorithm </text--->"
...
const string OShortestPathASpec =
  ...
  "<text>The operator uses an specialised ordered relation as graph "
  "representation for shortest path computing. Each tuple represents an edge"
  "of the graph consisting of at least of two integer attributes identifying"
  ...
  "contain further attributes giving additonal cost informations or arbitrary"
