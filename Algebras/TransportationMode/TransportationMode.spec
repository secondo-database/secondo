...
operator createmetroroute alias CREATEMETROROUTE pattern op(_)
...
operator path_to_building alias PATH_TO_BUILDING pattern op(_,_,_,_)
...
operator comm_path alias COMM_PATH pattern op(_,_,_,_,_,_,_,_)
operator merge_path alias MERGE_PATH pattern op(_,_)
