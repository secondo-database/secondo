...
operator test_walk_sp alias TEST_WALK_SP pattern op(_,_,_,_,_,_,_)
...
operator convexreg alias CONVEXREG pattern op(_,_,_)
operator distribute_region alias DISTRIBUTE_REGION pattern op(_,_,_)
operator getrect alias GETRECT pattern op(_,_,_,_,_,_)
