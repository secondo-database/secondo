...
operator createdoor alias CREATEDOOR pattern op(_,_,_,_,_,_)
operator createadjdoor alias CREATEDOOR pattern op(_,_,_,_,_,_,_)
operator path_in_region alias PATH_IN_REGION pattern op(_,_,_)
operator length_l3d alias LENGTH_3D pattern op(_)
