...
*/
#ifndef ALGEBRAS_DBSERVICE_OperatorDBSARG_HPP_
#define ALGEBRAS_DBSERVICE_OperatorDBSARG_HPP_
...
struct DBSARGInfo: OperatorInfo
{
    DBSARGInfo()
    {
        name = "DBSARG";
        ...
        syntax = "DBSARG(_)";
        meaning = "determine the tuple type of a relation by either retrieving "
