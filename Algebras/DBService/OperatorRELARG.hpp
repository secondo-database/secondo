...
*/
#ifndef ALGEBRAS_DBSERVICE_OperatorRELARG_HPP_
#define ALGEBRAS_DBSERVICE_OperatorRELARG_HPP_
...
struct RELARGInfo: OperatorInfo
{
    RELARGInfo()
    {
        name = "RELARG";
        signature = "(rel(tuple(X)))) -> (rel(tuple(X)))";
        syntax = "RELARG(_)";
        meaning = "Checks whether the first argument is a "
                  "relation and returns it";
