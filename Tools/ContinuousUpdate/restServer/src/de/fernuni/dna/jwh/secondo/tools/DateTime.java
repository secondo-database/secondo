...
package de.fernuni.dna.jwh.secondo.tools;
...
public static Double getDateTime(Date date){
	SimpleDateFormat df = new SimpleDateFormat(Configuration.values.secondoDateFormat);
	return getDateTime(df.format(date));
}
