...
SmiEnvironment::Err2Msg( SmiError code)
{
  if( !errorMapInitialized )
  {
    ...
    errorMap[ ERR_UPDATE_FOR_DERIVED_OBJ_UNSUPPORTED ] = 
    ...
    errorMap[ ERR_PROBLEM_IN_WRITING_TO_FILE ] = 
              "ERR_PROBLEM_IN_WRITING_TO_FILE";
    ...
    errorMap[ ERR_CMD_NOT_IMPL_AT_THIS_LEVEL ] = 
              "ERR_CMD_NOT_IMPL_AT_THIS_LEVEL";
    ...
    errorMap[ ERR_KIND_DOES_NOT_MATCH_TYPE_EXPR ] = 
              "ERR_KIND_DOES_NOT_MATCH_TYPE_EXPR";
    errorMap[ ERR_SPECIFIC_KIND_CHECKING_ERROR ] = 
              "ERR_SPECIFIC_KIND_CHECKING_ERROR";
 
    errorMap[ ERR_IN_VALUELIST_TC_V ] = "ERR_IN_VALUELIST_TC_V";
    errorMap[ ERR_SPECIFIC_FOR_TYPE_CONSTRUCTOR ] = 
              "ERR_SPECIFIC_FOR_TYPE_CONSTRUCTOR";
    ...
    errorMap[ ERR_OBJ_NAME_IN_FILE_NEQ_IDENT ] = 
              "ERR_OBJ_NAME_IN_FILE_NEQ_IDENT";
