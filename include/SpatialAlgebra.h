...
*/
    const bool Inside( Points& ps ) const;
/*
...
*/
    const bool Intersects(Points& ps);
/*
...
*/
    const int Position(const Point&);
/*
Searches (binary search algorithm) for a point in the point set and
...
*/
    const int Position(const CHalfSegment&);
/*
