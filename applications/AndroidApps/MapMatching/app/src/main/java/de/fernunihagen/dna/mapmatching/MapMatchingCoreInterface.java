...
public class MapMatchingCoreInterface extends Service implements MapMatchingListener {

    private static MapMatchingCoreInterface mapMatchingCoreInterface = new MapMatchingCoreInterface();
    private static MapMatching mapMatching = new MapMatching(mapMatchingCoreInterface);
    ...
    public void onCreate(){
        mapMatchingGps.setLocationManager((LocationManager) getApplicationContext().getSystemService(Context.LOCATION_SERVICE));

        Intent notificationIntent = new Intent(mapMatchingActivity, MapMatchingActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(mapMatchingActivity, 0,
                notificationIntent, 0);
        Notification notification = new NotificationCompat.Builder(this)
                .setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle("Secondo Map Matching")
                .setContentText("Map Matching Active")
    ...
    public static void setSettings() {
        ...
        boolean savedRandomizePosition = sharedPrefs.getBoolean(mapMatchingActivity.getString(R.string.preference_advancedRandomizePosition_key), Boolean.valueOf(mapMatchingActivity.getString(R.string.preference_advancedRandomizePosition_default)));
        int savedHeightIntervalRange = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedHeightIntervalRange_key), mapMatchingActivity.getString(R.string.preference_advancedHeightIntervalRange_default)));
        boolean savedUseSpeedIntervalRange = sharedPrefs.getBoolean(mapMatchingActivity.getString(R.string.preference_advancedUseSpeedIntervalRange_key), Boolean.valueOf(mapMatchingActivity.getString(R.string.preference_advancedUseSpeedIntervalRange_default)));
        int savedSpeedIntervalRange = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalRange_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalRange_default)));
        int savedIntervalEndpoint1 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint1_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint1_default)));
        int savedIntervalEndpoint2 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint2_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint2_default)));
        int savedIntervalEndpoint3 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint3_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint3_default)));
        int savedIntervalEndpoint4 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint4_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint4_default)));
        int savedIntervalEndpoint5 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint5_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint5_default)));
        int savedIntervalEndpoint6 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint6_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint6_default)));
        int savedIntervalEndpoint7 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint7_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint7_default)));
        int savedIntervalEndpoint8 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint8_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint8_default)));
        int savedIntervalEndpoint9 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint9_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint9_default)));
        int savedIntervalEndpoint10 = Integer.parseInt(sharedPrefs.getString(mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint10_key), mapMatchingActivity.getString(R.string.preference_advancedSpeedIntervalEndpoint10_default)));
    ...
    private static void setAdvancedSettings(boolean streetnameCalc, boolean preciseMPoint, boolean allowUTurns, boolean multipleUTurns, int boundingBoxSize, double boundingBoxRadius, int maxPathsSize, int extensionDepth, int resetDistance, boolean preferSmallerPaths,int preferSmallerPathsMalus, int uTurnMalus, boolean cleanPaths, int cleanPathsCount, int cleanPathsEdges, boolean footwaysDifferent, int footwaySpeed, int wayOrRoadMalus, int distanceMulti, boolean alwaysExtend, boolean footwayPerformance, boolean compareAngle, int compareAngleTolerance, boolean randomizePosition, int heightIntervalRange, boolean useSpeedIntervalRange, int speedIntervalRange, int intervalEndpoint1, int intervalEndpoint2, int intervalEndpoint3, int intervalEndpoint4, int intervalEndpoint5, int intervalEndpoint6, int intervalEndpoint7, int intervalEndpoint8, int intervalEndpoint9, int intervalEndpoint10){
        SymbolicTrajectory.setCalcStreetnameTime(streetnameCalc);
        SymbolicTrajectory.setHeightIntervalRange(heightIntervalRange);
        SymbolicTrajectory.setUseSpeedIntervalRange(useSpeedIntervalRange);
        SymbolicTrajectory.setSpeedIntervalRange(speedIntervalRange);
        SymbolicTrajectory.setSpeedIntervalEndpoint1(intervalEndpoint1);
        SymbolicTrajectory.setSpeedIntervalEndpoint2(intervalEndpoint2);
        SymbolicTrajectory.setSpeedIntervalEndpoint3(intervalEndpoint3);
        SymbolicTrajectory.setSpeedIntervalEndpoint4(intervalEndpoint4);
        SymbolicTrajectory.setSpeedIntervalEndpoint5(intervalEndpoint5);
        SymbolicTrajectory.setSpeedIntervalEndpoint6(intervalEndpoint6);
        SymbolicTrajectory.setSpeedIntervalEndpoint7(intervalEndpoint7);
        SymbolicTrajectory.setSpeedIntervalEndpoint8(intervalEndpoint8);
        SymbolicTrajectory.setSpeedIntervalEndpoint9(intervalEndpoint9);
        SymbolicTrajectory.setSpeedIntervalEndpoint10(intervalEndpoint10);
        ...
        mapMatching.setRandomizePositionForNetworkUpdates(randomizePosition);
    }
    ...
    public static class ProcessLocationPoint extends AsyncTask<Void, Void, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result) {
            if(!result){
                ...
                MapMatchingMap.updateMap(getMapResults());
    ...
    public static List<MapMatchingPath> getMapResults(){
        return mapMatching.getUtil().cleanResults(mapMatching.getAllResultsConnected());
    }
    ...
    public static MapMatchingCoreInterface getMapMatchingCoreInterface() {
        return mapMatchingCoreInterface;
    }

    public MapMatchingGps getMapMatchingGps() {
        return mapMatchingGps;
    }

    public static ArrayList<String> getConsoleText() {
        return consoleText;
    }

    public static void setConsoleText(ArrayList<String> consoleText) {
        MapMatchingCoreInterface.consoleText = consoleText;
    }
}