...
constants in the form of {~algId~, ~typeId~, ~value~}.  ~Annotate~ 
...
*/
void
QueryProcessor::DestroyValuesArray( const AlgebraLevel level )
{
                          ...
                          const ListExpr expr )
{
  ...
  bool first = true;  
  OpTree resultTree = Subtree( level, expr, first );
  if ( debugMode )
  {
