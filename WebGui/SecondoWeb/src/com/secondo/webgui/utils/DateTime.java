...
public class DateTime {
	...
	/**
	 * Represents the maximum representable instant. Ensure the same
	 * representation as in the DateTime-Algebra of the Secondo kernel.
	 **/
	private static final String endOfTime = "end of time";
	/**
	 * String describing the minimum representable instant. Ensure to use the
	 * same name as in the DateTime Algebra in the Secondo kernel.
	 **/
	private static final String beginOfTime = "begin of time";

	/**
	 * Value of the maximum representable instant. Ensure the same value as in
	 * the DateTime-Algebra of the Secondo kernel.
	 **/
	public static final long minInstant = -2450000;

	/**
	 * Value of the minimum representable instant. Ensure the same value as in
	 * the DateTime-Algebra of the Secondo kernel.
	 **/
	public static final long maxInstant = 2450000;

	/**
	 * The resolution of a day. A single day is divided into DAY_RESOLUTION
	 * parts.
	 **/
	public static final long DAY_RESOLUTION = 86400000; // 1 millisecond

	/* convert the given values to a Double representation */
	public static double convertToDouble(int year, int month, int day,
	...
	private static int getMilliSecs(int hour, int minute, int second,
			int millisecond) {
	...
	/**
	 * returns an array containing the day and the milliseconds of this day if
	 * the Format is not correct null will be returned
	 */
	...
	/**
	 * return the datevalue for DT, return 0 if format ist not correct required
