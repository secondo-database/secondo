...
public class Point extends GeneralType implements PointIF {
    ...
    * 
    * @see
    * stlib.interfaces.spatial.PointIF#distance(stlib.interfaces.spatial.PointIF,
    * boolean)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.spatial.PointIF#almostEqual(stlib.interfaces.spatial.
    * PointIF)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.spatial.PointIF#getXValue()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.spatial.PointIF#getYValue()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.spatial.PointIF#plus(stlib.util.Vector2D)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.spatial.PointIF#minus(stlib.interfaces.spatial.PointIF)
    */
   @Override
