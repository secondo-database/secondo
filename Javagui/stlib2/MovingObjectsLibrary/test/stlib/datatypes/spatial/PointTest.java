...
public class PointTest {
   ...
   public void testAlmostEqual_EqualPoints_ShouldBeEqual() {
      PointIF p1 = new Point(1.0d, 2.0d);
   ...
   public void testEquals_EqualPoints_ShouldBeTrue() {
      ...
      PointIF p1 = new Point(1.2d, 2.3d);
      PointIF p2 = new Point(1.2d, 2.3d);
   ...
   public void testEquals_NonEqualPoints_ShouldBeFalse() {
      ...
      PointIF p1 = new Point(1.2d, 2.3d);
      PointIF p2 = new Point(1.2d, 2.4d);
   ...
   public void testGetBoundingBox() {
      ...
      RectangleIF mbb = p1.getBoundingBox();
   ...
   public void testDistance_EuclideanDistance() {
      ...
      PointIF p1 = new Point(0.0d, 0.0d);
   ...
   public void testDistance_UseSphericalGeometry() {
      ...
      PointIF p1 = new Point(51.362328d, 7.463116d); // 51.362328, 7.463116
   ...
   public void testPlus_AddVectorToPoint() {
      ...
      PointIF initialPoint = new Point(4.0d, 2.0d);
      Vector2D vector = new Vector2D(5.0d, -7.0d);

      PointIF expectedPoint = new Point(9.0d, -5.0d);
   ...
   public void testMinus_SubtractPoint_GetVector() {
      ...
      PointIF finalPoint = new Point(10.0d, 15.0d);
