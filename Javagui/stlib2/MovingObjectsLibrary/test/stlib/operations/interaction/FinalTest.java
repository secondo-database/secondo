...
public class FinalTest {
   ...
   @Test
   public void testFinal_OnDefinedMBool_ShouldReturnDefinedIntimeBaseBool() {

      IntimeIF<BaseBoolIF> ibool = Final.execute(mbool);
   ...
   @Test
   public void testFinal_OnNullObject_ShouldReturnUndefinedIntimeBaseBool() {

      IntimeIF<BaseBoolIF> ibool = Final.execute(null);
   ...
   @Test
   public void testFinal_OnDefinedMPoint_ShouldReturnDefinedIntimePoint() {

      IntimeIF<PointIF> ipoint = Final.execute(mpointContinuos);

      assertTrue(ipoint.isDefined());
      assertEquals(new Point(20.0d, 5.0d), ipoint.getValue());
