...
public class OperatorLookup {
   ...
   /**
    * The map containing all known operator names and classes. It is a sorted map
    * to keep order in GUI operator-list.
    */
   ...
   private static SortedMap<String, Class<? extends Node>> initializeMap() {
      ...
      operatorMap.put("trajectory", Trajectory.class);
