...
DateType				=	date
DateValue				=	{DateType}" '"{digit}{4}-{digit}{2}-{digit}{2}"'"
...
UKey					=	global | local | temporary | collate | "not null" 
							| "on commit" | nullif | case | when | coalesce | cast
...
/* unsupported but tranferred keywords */
