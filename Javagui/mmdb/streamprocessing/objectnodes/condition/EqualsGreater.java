...
/**
 * Implementation of comparison operator EqualsGreater(>=) resembling the core
 * operator.<br>
...
public class EqualsGreater extends ComparisonOperator {
	...
	public static Node fromNL(ListExpr[] params, Environment environment)
		...
		ParserTools.checkListElemCount(params, 2, EqualsGreater.class);
		Node node1 = NestedListProcessor.nlToNode(params[0], environment);
		Node node2 = NestedListProcessor.nlToNode(params[1], environment);
		return new EqualsGreater(node1, node2);
	}
	 ...
	 */
	public EqualsGreater(Node input1, Node input2) {
		super(input1, input2);
	}
