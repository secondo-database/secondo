...
/**
 * This class represents the 'EQUALS_GREATER' operator.
 *
 * @author Alexander Castor
 */
public class OperatorEqualsGreater implements ConditionOperator {
	 ...
	 * @return true if the attribute is greater than the value, else false
	 */
