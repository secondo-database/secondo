...
public class SpatialObjects {
   ...
   /**
    * This class represents a segment which is a line in the plane. Although this
    * class is (not yet) a secondo attribute type, it extends MemoryAttribute to be
    * forced to implement fromList and toList.
    *
    * @author Alexander Castor
    */
   public static class Segment extends MemoryAttribute {
      ...
      public ListExpr toList() {
         return ListExpr.fourElemList(ListExpr.realAtom(getxValue1()), ListExpr.realAtom(getyValue1()),
               ListExpr.realAtom(getxValue2()), ListExpr.realAtom(getyValue2()));
      }
   ...
   /**
    * This class represents a face element consisting of an outer and hole cycles.
    *
    * @author Alexander Castor
    */
