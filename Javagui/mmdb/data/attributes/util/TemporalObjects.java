...
public class TemporalObjects {
   ...
   public static class Period implements Comparable<Period> {
      ...
      public ListExpr toList() {
         return ListExpr.fourElemList(getStartTime().toList(), getEndTime().toList(), ListExpr.boolAtom(isLeftClosed()),
               ListExpr.boolAtom(isRightClosed()));
      }
       ...
       * @return
       */
      public PeriodIF toPeriodIF() {

         return new stlib.datatypes.interval.Period(startTime.toTimeInstantIF(), endTime.toTimeInstantIF(),
               this.leftClosed, this.rightClosed);
      }
