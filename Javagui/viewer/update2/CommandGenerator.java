...
*/
	public String[] generateUpdate(String relName, String[] attrTypes, String[] attrNames,
									Vector btreeNames, Vector btreeAttrNames,
									Vector rtreeNames, Vector rtreeAttrNames, 
									int[] updateTuples) throws InvalidFormatException{
		String nextValue;
		String newValue;
		String nextType;
		String nextAttrName;
		String[] nextUpdateTuple = new String[0]; // TODO
		String[] nextOriginalTuple = new String[0]; // TODO
		int[] changedAttributes = new int[0]; // TODO
