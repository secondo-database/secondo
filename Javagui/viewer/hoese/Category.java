...
/** The path to the icon of a texture */  
  String IconPath;
/** Default-Category */
...
/** The stroke for the selection */
  ...
  /**
   * 
   * @return The icon-path for a texture
   * @see <a href="Categorysrc.html#getIconPath">Source</a>
   */
  ...
  /**
   * Sets the icon-path for a texture
   * @param path A Path as string
   * @see <a href="Categorysrc.html#setIconPath>Source</a> 
   */
  ...
  public static Category ConvertLEtoCat (ListExpr le) {
    ...
    if (le.first().atomType() != ListExpr.STRING_ATOM)
      return  null;
    cat.IconPath=le.first().stringValue();
    ImageIcon ii = new ImageIcon(cat.IconPath);
    if (ii == null)
      style = "nofill";
