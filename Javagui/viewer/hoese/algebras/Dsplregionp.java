...
/**
 * The displayclass of the regionp datatype (Rose algebra).
 */
public class Dsplregionp extends DisplayGraph {
  /** The internal datastructure of the regionp datatype */
  Area areas;
  boolean defined;
  ...
  /**
   * Init. the Dsplregionp instance.
   * @param type The symbol regionp
   * @param value A list of polygons /holepolygons
   * @param qr queryresult to display output.
   * @see generic.QueryResult
   * @see sj.lang.ListExpr
   * @see <a href="Dsplregionpsrc.html#init">Source</a>
   */
   public void init (String name, int nameWidth, int indent, ListExpr type, ListExpr value, QueryResult qr) {
    ...
    if (err) {
      ...
      qr.addEntry((AttrName)+" : Error(regionp)");
      return;
    } else if(!defined){
