...
/**
 * A displayclass for the lustring
 */
public class Dspllustring extends DsplGeneric {
    ...
    public void init(String name, int nameWidth, int indent, ListExpr type, ListExpr value, QueryResult qr) {
        ...
        if (value.listLength() == 2) {
            ...
            if (interval != null) {
                ListExpr stringval = value.second();
                if (stringval.atomType() != ListExpr.STRING_ATOM) {
                    interval = null;
                } else {
                    this.value = stringval.stringValue();
                }
            }
        }
