 ...
 */
public class Dsplcrel extends DsplGeneric {
  ...
  public void init (String name, int nameWidth, int indent, ListExpr type, ListExpr value, QueryResult qr) {
    ...
    ListExpr attrList = type.second().second().second().second();
    ListExpr tupleList = ListExpr.twoElemList( ListExpr.symbolAtom("tuple"), attrList);

    System.out.println("tupleList " + tupleList);

    LEUtils.analyse(name, nameWidth, indent, tupleList, value, qr);
    if(tools.Environment.MEASURE_TIME){
