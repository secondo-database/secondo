...
import viewer.hoese.algebras.jnet.JPoint;
import viewer.hoese.algebras.jnet.JNetworkNotAvailableException;

/**
 * @author Simone Jandt
 *
 * Views JPoint in the Hoese-Viewer
 *
 */
public class Dspljpoint extends DisplayGraph
{
                               ...
                               AffineTransform in_xAf)
  {
    try
    {
      Point2D.Double xPoint = jp.getRenderObject();
 ...
 public Rectangle2D.Double getBounds ()
 {
   try
   {
     return new Rectangle2D.Double(jp.getRenderObject().x,
                                   jp.getRenderObject().y,
                                   0,
                                   0);
   }
   catch (JNetworkNotAvailableException xEx)
