...
public class ServerErrorCodes extends Object {
  ...
  static {
    ...
    errors.setElementAt("Expression not evaluable. (Operator not recognized or stream?)", 
        3);
    ...
    errors.setElementAt("Type of expression is different from type of object. ", 
        13);
    errors.setElementAt("Type name is used by an object. Type not deleted. ", 
        14);
    ...
    errors.setElementAt("Database name in file different from identifier. ", 
        27);
    ...
    errors.setElementAt("Value list is not a representation for type constructor. ", 
        70);                    //	(70 tc v)     
    errors.setElementAt("Specific error for type constructor in value list. ", 
        71);                    //	(71 tc j ...) 
    errors.setElementAt("Value list is not a representation for type constructor. ", 
        72);                    //	(72 tc)       
    errors.setElementAt("Error at a position within value list for type constructor. ", 
        73);                    //	(73 pos)
    // This two error codes were defined in addition to the error codes 
    // returned by the Secondo Server.
