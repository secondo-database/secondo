...
public class CustomPickTranslate extends PickMouseBehavior implements
...
/**
 * Creates a pick/translate behavior that waits for user
 ...
 **/
  ...
  public CustomPickTranslate(BranchGroup root, Canvas3D canvas,
    Bounds bounds) {
      super(canvas, root, bounds);
      // set translate
      translate = new MouseTranslate(MouseBehavior.MANUAL_WAKEUP);
//       translate.setFactor(0.02);                  // standard factor = 0.02
  ...
  public void updateScene(int xpos, int ypos) {
    ...
    if (!mevent.isControlDown() && !mevent.isAltDown() && mevent.isMetaDown()) {       // right mouse Button
