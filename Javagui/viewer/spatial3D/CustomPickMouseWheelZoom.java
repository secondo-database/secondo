...
public class CustomPickMouseWheelZoom extends PickMouseBehavior implements
MouseBehaviorCallback {

  MouseWheelZoom wheelZoom;
  private PickingCallback callback = null;
  private TransformGroup currentTG;

/**
 * Creates a pick/mouse wheel zoom behavior that waits for user
 ...
 **/
  ...
  public CustomPickMouseWheelZoom(BranchGroup root, Canvas3D canvas,
    Bounds bounds) {
      super(canvas, root, bounds);
    
      // set WheelZoom
      wheelZoom = new MouseWheelZoom(MouseBehavior.MANUAL_WAKEUP);
      wheelZoom.setTransformGroup(currGrp);
      currGrp.addChild(wheelZoom);
  ...
  public void setupCallback(PickingCallback callback) {
    ...
    if (callback == null)
      wheelZoom.setupCallback(null);
    else
      wheelZoom.setupCallback(this);
    }
    
  public void setFactor(double factor) {
    wheelZoom.setFactor(factor);
    }
