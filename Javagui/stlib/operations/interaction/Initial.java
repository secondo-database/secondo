...
/**
 * Class with 'Initial' operations on temporal spatial types
 * 
...
public class Initial {
   ...
   /**
    * Get the first defined value at the first defined instant of the passed
    * 'MovingObject'
    * 
    * @param mobject
    *           - the 'MovingObject'
   ...
   public static <T extends GeneralTypeIF> IntimeIF<T> execute(final MovingObjectIF<?, T> mobject) {
      ...
      if (mobject == null || !mobject.isDefined() || mobject.getNoUnits() == 0) {
         ...
         T value = mobject.getUnit(0).getInitial();
         TimeInstantIF instant = mobject.getUnit(0).getPeriod().getLowerBound();
