...
import stlib.interfaces.range.RangeIntIF;
...
public class RangeInt extends Range<BaseIntIF> implements RangeIntIF {
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.range.RangeIntIF#first()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.range.RangeIntIF#last()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.range.RangeIntIF#get(int)
    */
   @Override
