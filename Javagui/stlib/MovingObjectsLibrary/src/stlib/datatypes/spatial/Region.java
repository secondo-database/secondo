...
public class Region extends GeneralType implements RegionIF {
    ...
    * 
    * @see
    * stlib.interfaces.spatial.RegionIF#add(stlib.interfaces.spatial.util.FaceIF)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.spatial.RegionIF#getNoComponents()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.spatial.RegionIF#getHalfsegments()
    */
   @Override
