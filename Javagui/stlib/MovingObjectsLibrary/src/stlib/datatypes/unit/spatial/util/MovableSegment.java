...
public class MovableSegment implements MovableSegmentIF {
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.unit.spatial.util.MovableSegmentIF#getValue(stlib.
    * interfaces. interval.PeriodIF, stlib.interfaces.time.TimeInstantIF)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.unit.spatial.util.MovableSegmentIF#getInitial()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.unit.spatial.util.MovableSegmentIF#getFinal()
    */
   @Override
    ...
    * 
    * @see
    * stlib.interfaces.unit.spatial.util.MovableSegmentIF#getInitialStartPoint()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.unit.spatial.util.MovableSegmentIF#getFinalStartPoint()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.unit.spatial.util.MovableSegmentIF#getInitialEndPoint()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see stlib.interfaces.unit.spatial.util.MovableSegmentIF#getFinalEndPoint()
    */
   @Override
