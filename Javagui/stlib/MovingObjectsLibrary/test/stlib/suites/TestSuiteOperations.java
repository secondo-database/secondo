...
@RunWith(Suite.class)
@SuiteClasses({ InitialTest.class, FinalTest.class, AtInstantTest.class, PassesTest.class, PresentTest.class,
      InsideTest.class, InsidePointRegionTest.class, TrajectoryTest.class, DeftimeTest.class })
