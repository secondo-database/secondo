...
package unittests.mmdb;

import unittests.mmdb.suites.TestSuiteData;
...
/**
 * Suite for collecting all tests within the "mmdb" module including the suites
 * for "data", "operator", "query" and "service".
 *
