...
public class MapMatchingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapMatchingGps.updateLocationManager(this);
        ...
        if (savedInstanceState != null) {
            ...
            consoleText = savedInstanceState.getStringArrayList("consoleText");
    ...
    private void startStopButtonClick() {
        if (MapMatchingCoreInterface.isMapMatchingActive()) {
            ...
            if (MapMatchingGps.checkGpsEnabledAndPermissions()) {
                mapMatchingStart();
            }
        }
    }
    ...
    public void mapMatchingStart() {
        ...
        MapMatchingCoreInterface.startMapMatching();
        //TestData.test();
    }
    ...
    private void cleanConsoleText(){
        if(consoleText.size()>2000){
            consoleText = new ArrayList<String>(consoleText.subList(250,consoleText.size()));
            console.setText("");
            refreshConsole();
        }
    }
    ...
    private void refreshConsole() {
        for (String message : consoleText) {
            console.append(Html.fromHtml(message));
        }
        scrollConsoleDown();
    }
    ...
    private void showWelcomeMessage(){
        ...
        consoleText.add(welcomeMessage);
