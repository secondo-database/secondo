...
public class TestData {
    ...
    //Test Route
    static Point point1 = new Point( 51.50799055752574,7.466119229793549 ,285 , 7, 5, System.currentTimeMillis());
    static Point point2 = new Point(51.50807770121974, 7.465852349996567, 285, 6, 7, System.currentTimeMillis()+20000);
    static Point point3 = new Point(51.50811075572293, 7.465586364378396, 285, 8, 16, System.currentTimeMillis()+40000);
    static Point point4 = new Point(51.508190887678225, 7.46524304162449,285 , 35, 31, System.currentTimeMillis()+60000);
    static Point point5 = new Point(51.508257664199995, 7.464931905378762, 285, 45, 51, System.currentTimeMillis()+80000);
    static Point point6 = new Point(51.50846133198691, 7.464835345854226, 355, 80, 81, System.currentTimeMillis()+100000);

    static Point point7 = new Point(51.50871841953274, 7.464776337255898, 355, 0, 101, System.currentTimeMillis()+120000);
    static Point point8 = new Point(51.50902892593318, 7.464765608419839, 355, -20, 121, System.currentTimeMillis()+140000);
    static Point point9 = new Point(51.50924260652791, 7.46473878632969, 355, 15, 151, System.currentTimeMillis()+160000);
    static Point point10 = new Point(51.509472979796435, 7.46474415074772, 355, 25, 201, System.currentTimeMillis()+180000);
    static Point point11 = new Point(51.50964993233461, 7.464717328657571, 355, -68, 251, System.currentTimeMillis()+200000);
...
//    static Point point10 = new Point(51.50665833960647, 7.457428872585297, 100, 25, 6, System.currentTimeMillis()+180000);
    ...
    static Point skippedStreet3 = new Point(51.51174660126075,7.485656440258026 ,270 , 11, 5, System.currentTimeMillis()+70000);
    ...
    // extension problem without compareAngle
    static Point heiligerweg  = new Point(51.507459678310695, 7.473516762256622, 70, 25, 30, System.currentTimeMillis());
    static Point heiligerweg1  = new Point(51.507810259584396, 7.474487721920013, 70, 25, 30, System.currentTimeMillis());
    static Point heiligerweg2  = new Point(51.5081207721741, 7.47456282377243, 350, 25, 30, System.currentTimeMillis());
    static Point heiligerweg3  = new Point(51.50835115111509, 7.474627196788788, 350, 25, 30, System.currentTimeMillis());


    static Point testPoint  = new Point(51.39740905099337, 7.468997240066528, 350, 25, 30, System.currentTimeMillis());

    //static Point[] test = {testPoint};
...
//    static Point[] test = {heiligerweg,heiligerweg1,heiligerweg2,heiligerweg3};
