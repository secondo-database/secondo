...
public class MapMatchingUtilities {
    ...
    public double percentalSpanOfProjectedPointsMappedToLastEdge(MapMatchingPath path) {
        int indexOfLastEdge = path.getEdges().size() - 1;
        NetworkEdge edge = path.getEdges().get(indexOfLastEdge);
        ...
        double percentalSpan = (distance * 100) / distanceOfEdge(edge);
