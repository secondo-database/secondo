...
public class MVPolygonController {
	 ...
	 *            The Bounds object
	 */
	public void addPolygonPoint(double lat, double lng, Bounds boundsAll,
			Bounds boundsLast) {
	...
	/**
	 * Creates a linear ring representing a polygon and adds it to the
	 * polygonarray
	 * 
	 * @param key
	 *            The ID of the polygon to be added
	 * */
	public void addPolygon(Integer key) {

		LinearRing polygon = new LinearRing(
				polygonPointArray.toArray(new Point[polygonPointArray.size()]));
	 ...
	 * 
	 * @param polygon
	 *            The polygon to be shown on the map
	 * */
	 ...
	 * 
	 * @param polygon
	 *            The polygon the be hidden from the map
	 * */
