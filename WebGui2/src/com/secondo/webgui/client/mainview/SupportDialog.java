...
/**
 * This class represents a support dialog allowing to send a request to the
 * support
 * 
...
public class SupportDialog {
	...
	/**
	 * Returns the support dialog box
	 * 
	 * @return The support dialog box
	 */
	...
	/**
	 * Removes all user's data after send button is clicked
	 */
	...
	public String getMessage() {
		String message = "<h3>Support Request</h3> <p>"
				...
				+ "<p><b>Sender's Email: </b>" + email.getText() + "<p>"
